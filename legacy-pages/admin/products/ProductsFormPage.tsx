...
import type { ProductFormProps } from "./new/ProductsForm";

interface ProductsFormPageProps {
  FormComponent: ComponentType<ProductFormProps>;
  title: string;
}
...
export default function ProductsFormPage({
  ...
  const form = useAppSelector((state) => state.products.form);
