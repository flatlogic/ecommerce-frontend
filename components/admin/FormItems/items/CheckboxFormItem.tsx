...
interface BoundCheckboxFormItemProps extends CheckboxFormItemProps {
  form: FormikProps<FormRecord>;
}

export class CheckboxFormItemNotFast extends Component<BoundCheckboxFormItemProps> {
  override render() {
...
class CheckboxFormItem extends Component<CheckboxFormItemProps> {
  override render() {
    return (
